...
bg="skyblue"
wn = tk.Tk()
wn.geometry(f"{s.WIDTH}x{s.HEIGHT}")
...
pygame.mixer.init()
pygame.mixer.music.load("assets/gameskasoundmain.mp3")
...
def credits():
    ...
    wn2.geometry(f"{s.WIDTH}x{s.HEIGHT}")
